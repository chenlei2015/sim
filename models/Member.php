...
class Member extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['member_name', 'member_passwd', 'member_email', 'member_time', 'member_login_time', 'member_old_login_time', 'rebate_goods_amount', 'rebate_get_amount', 'prize_num', 'prize_time', 'operator_rebate', 'operator_service', 'is_service', 'service_name', 'service_add_time', 'service_refuse_text', 'service_get_amount', 'service_areaid', 'service_goods_amount', 'service_detail_addr'], 'required'],
            [['member_sex', 'member_login_num', 'member_points', 'inform_allow', 'is_buy', 'is_allowtalk', 'member_state', 'member_credit', 'member_snsvisitnum', 'member_areaid', 'member_cityid', 'member_provinceid', 'member_add_land_condition', 'rebate_state', 'rebate_add_time', 'can_eidt_num', 'member_login_days', 'rebate_is_sent', 'rebate_order_num', 'app_prize_num', 'app_prize_time', 'register_method', 'prize_num', 'prize_time', 'rebate_recommender_id', 'is_service', 'service_add_time', 'member_attr', 'is_vdata', 'jr_type', 'service_areaid', 'is_service_center'], 'integer'],
